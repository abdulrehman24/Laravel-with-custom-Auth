...
<!-- Mirrored from pixinvent.com/demo/convex-bootstrap-admin-dashboard-template/demo-1/login-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Dec 2022 11:36:03 GMT -->
<head>
            ...
            <div class="col-12 d-flex align-items-center justify-content-center gradient-aqua-marine">
                <div class="card px-4 py-2 box-shadow-2 width-400">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" id="inputEmail" value="{{ old('email') }}" placeholder="Email Address" required email>
                                        @error('email')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0 ml-5">
                                                <input type="checkbox" class="custom-control-input" id="remember" {{ old('remember') ? 'checked' : '' }} value="1">
                                                <label class="custom-control-label float-left" for="remember"> {{ __('Remember Me') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer grey darken-1">
                        <div class="text-center mb-1"> {{ __('Forgot Your Password?') }} 
